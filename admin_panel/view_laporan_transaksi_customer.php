...
<body>
    <div class="container">
        ...
        <div class="text-right" style="margin-bottom: 20px;">
            <a href="index.php?insert_laporan_transaksi_customer" class="btn btn-success">
                <i class="fa fa-plus"></i> Tambahkan Transaksi
            </a>
        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($bukti_pembayaran) { ?>
                                                <img src="images/bukti_pembayaran/<?php echo $bukti_pembayaran ?>" alt="Gambar Kamar" width="100">
                                            <?php } else { ?>
                                                <span>Gambar tidak tersedia</span>
                                            <?php } ?>
                                        </td>
                                        <td>
                                            <a href="index.php?edit_laporan_transaksi_customer&id_transaksi=<?php echo $id_transaksi; ?>"
                                                class="btn btn-primary btn-sm">
                                                <i class="fa fa-pencil"></i> Edit
                                            </a>
                                        </td>
                                        <td>
                                            <a href="index.php?delete_laporan_transaksi_customer&id_transaksi=<?php echo $id_transaksi; ?>"
                                                class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus transaksi ini?');">
