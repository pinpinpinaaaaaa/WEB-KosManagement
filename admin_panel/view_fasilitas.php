...
<body>
    <div class="container">
        ...
        <div class="text-right" style="margin-bottom: 20px;">
            <a href="index.php?insert_fasilitas" class="btn btn-success">
                <i class="fa fa-plus"></i> Tambahkan Fasilitas
            </a>
        </div>
                    ...
                    <table id="fasilitasTable" class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="index.php?edit_fasilitas&id_fasilitas=<?php echo $id_fasilitas; ?>" class="btn btn-primary btn-sm">
                                        <i class="fa fa-pencil"></i> Edit
                                    </a>
                                </td>
                                <td>
                                    <a href="index.php?delete_fasilitas&id_fasilitas=<?php echo $id_fasilitas; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus fasilitas ini?');">
