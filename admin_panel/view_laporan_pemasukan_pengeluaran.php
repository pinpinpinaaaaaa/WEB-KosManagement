...
<body>
    <div class="container">
        ...
        <div class="text-right" style="margin-bottom: 20px;">
            <a href="index.php?insert_laporan_pemasukan_pengeluaran" class="btn btn-success">
                <i class="fa fa-plus"></i> Tambahkan Laporan Pemasukan/Pengeluaran
            </a>
        </div>
                            ...
                            if (mysqli_num_rows($run_laporan) > 0) {
                                while ($row_laporan = mysqli_fetch_assoc($run_laporan)) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="index.php?edit_laporan_pemasukan_pengeluaran&id_laporan=<?php echo $id_laporan; ?>"
                                                class="btn btn-primary btn-sm">
                                                <i class="fa fa-pencil"></i> Edit
                                            </a>
                                        </td>
                                        <td>
                                            <a href="index.php?delete_laporan_pemasukan_pengeluaran&id_laporan=<?php echo $id_laporan; ?>"
