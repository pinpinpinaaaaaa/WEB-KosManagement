...
<body>
    <div class="container">
        ...
        <div class="text-right" style="margin-bottom: 20px;">
            <a href="index.php?insert_laporan_gaji" class="btn btn-success">
                <i class="fa fa-plus"></i> Tambahkan Laporan Gaji
            </a>
        </div>
                    ...
                    <table id="laporanGajiTable" class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="index.php?edit_laporan_gaji&id_gaji=<?php echo $id_gaji; ?>" class="btn btn-primary btn-sm">
                                        <i class="fa fa-pencil"></i> Edit
                                    </a>
                                </td>
                                <td>
                                    <a href="index.php?delete_laporan_gaji&id_gaji=<?php echo $id_gaji; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus laporan gaji ini?');">
