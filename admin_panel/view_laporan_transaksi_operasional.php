...
<body>
    <div class="container">
        ...
        <div class="text-right" style="margin-bottom: 20px;">
            <a href="index.php?insert_laporan_transaksi_operasional" class="btn btn-success">
                    ...
                    <table id="transaksiOperasionalTable" class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="index.php?edit_laporan_transaksi_operasional&id_transaksi=<?php echo $id_transaksi; ?>" class="btn btn-primary btn-sm">
                                        <i class="fa fa-pencil"></i> Edit
                                    </a>
                                </td>
                                <td>
                                    <a href="index.php?delete_laporan_transaksi_operasional&id_transaksi=<?php echo $id_transaksi; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus transaksi ini?');">
